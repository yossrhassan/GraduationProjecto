...
import 'package:graduation_project/features/booking_history/presentation/views/widgets/booking_history_view_body.dart';
...
class BookingHistoryView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const BookingHistoryViewBody();
  }
}
